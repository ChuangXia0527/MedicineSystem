<template>
  <el-container>
    <el-main style="padding: 40px; background-color: #fafbfc;">
      ...
      "
      >
        <h3 style="font-size: 20px; color: #333; font-weight: bold; margin-bottom: 20px;">搜索顾客信息</h3>
        <el-form :model="searchForm" inline>
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="编号">
                <el-input v-model="searchForm.cno" placeholder="请输入编号" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="顾客姓名">
                <el-input v-model="searchForm.cname" placeholder="请输入顾客姓名" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="性别">
                <el-select v-model="searchForm.csex" placeholder="请选择顾客性别" clearable>
            ...
            <el-col :span="6">
              <el-form-item label="年龄">
                <el-input v-model="searchForm.cage" placeholder="请输入年龄" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="住址">
                <el-input v-model="searchForm.caddress" placeholder="请输入住址" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="电话号码">
                <el-input v-model="searchForm.cphone" placeholder="请输入电话号码" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="症状">
                <el-input v-model="searchForm.csymptom" placeholder="请输入症状" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="药品编号">
                <el-input v-model="searchForm.mno" placeholder="请输入药品编号" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="经办编号">
                <el-input v-model="searchForm.ano" placeholder="请输入经办编号" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="日期">
                <el-date-picker
                    v-model="searchForm.cdate"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy-MM-dd"
...
<!--      &lt;!&ndash; 操作按钮 &ndash;&gt;
      ...
      <el-dialog :title="isEditing ? '编辑顾客' : '添加顾客'" :visible.sync="dialogVisible">
        <el-form :model="currentclient" label-width="100px">
          ...
          <el-form-item label="电话" prop="aphone">
            <el-input type="textarea" v-model="currentclient.cphone" required placeholder="" rows="1"></el-input>
          </el-form-item>
      ...
      >
        ...
        <el-table-column prop="cname" label="顾客姓名" width="120"></el-table-column>
        <el-table-column prop="csex" label="性别" width="60"></el-table-column>
        <el-table-column prop="cage" label="年龄" width="80"></el-table-column>
        <el-table-column prop="caddress" label="地址" width="200"></el-table-column>
        ...
        <el-table-column prop="mno" label="药品编号" width="80"></el-table-column>
        <el-table-column prop="ano" label="经办编号" width="80"></el-table-column>
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            <el-button @click="editclient(scope.row)" type="text" size="small" style="color: #42b983;" v-role="'管理员'">编辑</el-button>
            <el-button @click="deleteclient(scope.row.cno)" type="text" size="small" style="color: #e53935;" v-role="'管理员'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-main>
